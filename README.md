#This new branch is the "Retextured" branch, it is no longer a fork of Beta Continuum or other resource packs, it's based on it's own older version and it's compatible with newer versions
